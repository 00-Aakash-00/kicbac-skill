---
name: kicbac
description: Use when building, documenting, or reviewing Kicbac payment integrations, including Node, Python, React, Next.js, Collect.js tokenization, Customer Vault, subscriptions, ACH, webhooks, test mode, response codes, declines, gateway errors, OpenAPI docs, or LLM-agent guardrails.
---

# Kicbac

Use this skill for Kicbac developer-platform work. Kicbac white-labels the NMI gateway at `https://kicbac.transactiongateway.com` and uses classic form-encoded gateway APIs behind the SDKs.
...
4. Refuse or rewrite unsafe examples that collect raw payment data outside Collect.js hosted fields.

## Required Guardrails

- Tokenize with Collect.js or Kicbac hosted fields. Do not generate custom raw card, CVV, routing, or account-number inputs.
...
- Do not use Three-Step Redirect, Authorize.Net emulator endpoints, or username/password gateway auth in generated examples.
...
Kicbac/NMI gateway responses usually return HTTP 200. The business outcome is in the gateway body:
